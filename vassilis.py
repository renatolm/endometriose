...
def vassilis_defuzz(dism,disp,dor,cans):
	...
	def integrandoDismenorreiaModEsq(h):
		return (10+nivel_moderado_decresc(h)-nivel_moderado_cresc(h))/(10+nivel_moderado_decresc(h)-dismenorreia)

	def integrandoDismenorreiaModDir(h):
		return (10+nivel_moderado_decresc(h)-nivel_moderado_cresc(h))/(10+dismenorreia - nivel_moderado_cresc(h))
	...
	def dismenorreiaLeve():
		if dismenorreia == 0:
			return 1
		elif dismenorreia > 0 and dismenorreia < 5:
			h = 1 - (0.2*dismenorreia)
			return h + integrate.quad(integrandoDismenorreiaLeve, h, 1)[0]
		else:
	...
	def dismenorreiaModerada():	
		if dismenorreia < 5:
			h = 0.2*dismenorreia
			return h + integrate.quad(integrandoDismenorreiaModEsq, h, 1)[0]
		elif dismenorreia > 5:
			h = 2 - (0.2*dismenorreia)
			return h + integrate.quad(integrandoDismenorreiaModDir, h, 1)[0]
		else:
			return 1
	...
	def dismenorreiaIntensa():
		...
		elif dismenorreia > 5 and dismenorreia < 10:
			h = (0.2*dismenorreia) - 1
			return h + integrate.quad(integrandoDismenorreiaIntensa, h, 1)[0]
		else:
			return 1
	...
	def integrandoDispareuniaModEsq(h):
		return (10+nivel_moderado_decresc(h)-nivel_moderado_cresc(h))/(10+nivel_moderado_decresc(h)-dispareunia)

	def integrandoDispareuniaModDir(h):
		return (10+nivel_moderado_decresc(h)-nivel_moderado_cresc(h))/(10+dispareunia - nivel_moderado_cresc(h))
	...
	def dispareuniaLeve():
		if dispareunia == 0:
			return 1
		elif dispareunia > 0 and dispareunia < 5:
			h = 1 - (0.2*dispareunia)
			return h + integrate.quad(integrandoDispareuniaLeve, h, 1)[0]
		else:
	...
	def dispareuniaModerada():	
		if dispareunia < 5:
			h = 0.2*dispareunia
			return h + integrate.quad(integrandoDispareuniaModEsq, h, 1)[0]
		elif dispareunia > 5:
			h = 2 - (0.2*dispareunia)
			return h + integrate.quad(integrandoDispareuniaModDir, h, 1)[0]
		else:
			return 1
	...
	def dispareuniaIntensa():
		...
		elif dispareunia > 5 and dispareunia < 10:
			h = (0.2*dispareunia) - 1
			return h + integrate.quad(integrandoDispareuniaIntensa, h, 1)[0]
		else:
			return 1
	...
	def integrandoDorCPModEsq(h):
		return (10+nivel_moderado_decresc(h)-nivel_moderado_cresc(h))/(10+nivel_moderado_decresc(h)-dorNasCostasPernas)

	def integrandoDorCPModDir(h):
		return (10+nivel_moderado_decresc(h)-nivel_moderado_cresc(h))/(10+dorNasCostasPernas - nivel_moderado_cresc(h))
	...
	def dorCPLeve():
		if dorNasCostasPernas == 0:
			return 1
		elif dorNasCostasPernas > 0 and dorNasCostasPernas < 5:
			h = 1 - (0.2*dorNasCostasPernas)
			return h + integrate.quad(integrandoDorCPLeve, h, 1)[0]
		else:
			return integrate.quad(integrandoDorCPLeve, 0, 1)[0]

	def dorCPModerada():	
		if dorNasCostasPernas < 5:
			h = 0.2*dorNasCostasPernas
			return h + integrate.quad(integrandoDorCPModEsq, h, 1)[0]
		elif dorNasCostasPernas > 5:
			h = 2 - (0.2*dorNasCostasPernas)
			return h + integrate.quad(integrandoDorCPModDir, h, 1)[0]
		else:
			return 1
	...
	def dorCPIntensa():
		...
		elif dorNasCostasPernas > 5 and dorNasCostasPernas < 10:
			h = (0.2*dorNasCostasPernas) - 1
			return h + integrate.quad(integrandoDorCPIntensa, h, 1)[0]
		else:
			return 1
	...
	def integrandoCansacoModEsq(h):
		return (10+nivel_moderado_decresc(h)-nivel_moderado_cresc(h))/(10+nivel_moderado_decresc(h)-cansaco)

	def integrandoCansacoModDir(h):
		return (10+nivel_moderado_decresc(h)-nivel_moderado_cresc(h))/(10+cansaco - nivel_moderado_cresc(h))

	def integrandoCansacoIntenso(h):
		return (10+10-nivel_intenso_cresc(h))/(10+10-cansaco)

	def cansacoLeve():
		if cansaco == 0:
			return 1
		elif cansaco > 0 and cansaco < 5:
			h = 1 - (0.2*cansaco)
			return h + integrate.quad(integrandoCansacoLeve, h, 1)[0]
		else:
	...
	def cansacoModerado():	
		if cansaco < 5:
			h = 0.2*cansaco
			return h + integrate.quad(integrandoCansacoModEsq, h, 1)[0]
		elif cansaco > 5:
			h = 2 - (0.2*cansaco)
			return h + integrate.quad(integrandoCansacoModDir, h, 1)[0]
		else:
			return 1

	def cansacoIntenso():
		if cansaco <= 5:
			return integrate.quad(integrandoCansacoIntenso, 0, 1)[0]
		elif cansaco > 5 and cansaco < 10:
			h = (0.2*cansaco) - 1
			return h + integrate.quad(integrandoCansacoIntenso, h, 1)[0]
		else:
			return 1
